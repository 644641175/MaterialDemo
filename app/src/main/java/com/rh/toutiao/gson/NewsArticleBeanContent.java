 ...
 * @date 2018/2/6
 */
public class NewsArticleBeanContent implements Parcelable {

    public static final Parcelable.Creator<NewsArticleBeanContent> CREATOR = new Parcelable.Creator<NewsArticleBeanContent>() {
        @Override
        public NewsArticleBeanContent createFromParcel(Parcel in) {
            return new NewsArticleBeanContent(in);
        }

        @Override
        public NewsArticleBeanContent[] newArray(int size) {
            return new NewsArticleBeanContent[size];
        }
    };
    /**
    ...
    public NewsArticleBeanContent() {
    }
    protected NewsArticleBeanContent(Parcel in) {
...
//        has_m3u8_video = in.readByte() != 0;
    ...
    public boolean equals(Object o) {
        ...
        NewsArticleBeanContent that = (NewsArticleBeanContent) o;
